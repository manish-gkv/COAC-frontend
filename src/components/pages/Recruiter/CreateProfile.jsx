      ...
      <form onSubmit={handleSubmit} className={cn("flex flex-col gap-6 mt-10", className)} {...props}>
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-muted-foreground text-sm text-balance">
            Enter your email below to create your company profile
          </p>
        </div>
        <div className="grid gap-6">
          <div className="grid gap-3">
            <Label htmlFor="companyName">Company Name<span className="text-primary">*</span></Label>
            <Input id="companyName" type="text" name="companyName" placeholder="Your Company Name" required value={formData.companyName} onChange={handleChange} />
          </div>
          <div className="grid gap-3">
