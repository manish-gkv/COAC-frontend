...
function GoogleLoginButton() {
    ...
    const responseGoogle = async (authResult) => {
        ...
        try{
            if(authResult?.credential){
                ...
                await googleLogin(authResult.credential);
                navigate("/");
            }
        }
        catch(err){
    ...
    return (
        <div className="flex mx-auto justify-center"><GoogleLogin logo_alignment="center" theme="filled_blue"
        ...
        <div className="grid min-h-svh lg:grid-cols-2 overflow-hidden">
            ...
            <div className="bg-muted relative hidden lg:block">
                <img
                    src="/logo.png"
                    alt="Image"
                    className="absolute p-8 inset-0 h-full w-full  dark:brightness-[0.2] dark:grayscale"
                />
            </div>
        </div>
    )
